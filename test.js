...
async function test () {
  ...
  // Step 1 process
  process.stdout.write('node listenerNode.js\n')
  const listenerProc = startProcess('src/listenerNode.js')
  ...
  // Step 2 process
  process.stdout.write('node dialerNode.js\n')
  const dialerProc = startProcess('src/dialerNode.js')
